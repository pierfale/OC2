...
public:
	...
	static FitnessPoint<Objective> execute(Instance<Size, Objective>& instance, Solution<Size>& solution) {
	...
	template<unsigned int Size, unsigned int Objective>
	static unsigned int unique(Instance<Size, Objective>& instance, Solution<Size>& solution, unsigned int current_objective) {
